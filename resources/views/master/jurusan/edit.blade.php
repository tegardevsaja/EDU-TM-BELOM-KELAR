<x-layouts.app :title="__('Edit Jurusan')">
    <div class="max-w-xl mx-auto mt-6">
        <div class="bg-white rounded-xl border border-gray-200 p-6">
            <div class="mb-4">
                <h2 class="text-xl font-semibold text-gray-900">Edit Jurusan</h2>
                <p class="mt-1 text-sm text-gray-500">Perbarui nama jurusan dengan benar agar data kelas dan siswa tetap konsisten.</p>
            </div>
            ...
            {{-- Form edit jurusan --}}
            <form action="{{ route('master.jurusan.update', $jurusan->id) }}" method="POST" class="space-y-4">
